...
class RandomItemMgr
{
	...
	public:
        ...
        // Return the cached list by reference for hot equipment-generation paths
        // that probe many nearby levels and slots and do not need a copy.
        RandomItemList const& QueryCache(uint32 level, uint8 clazz, uint8 specId, uint8 slot, uint32 quality);
